...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/templates.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.filtersTemplate = exports.fieldOfWorkTemplate = exports.jobTemplate = exports.jobsTemplate = void 0;
...
var jobsTemplate = function jobsTemplate(jobDTO) {
  var job = jobDTO.job;
  var date = new Date(job.createdAt).toDateString();
  var t = "#" + job.tech[0];

  for (var i = 1; i < job.tech.length; i++) {
    t += " \xa0\xa0\xa0\xa0 #" + job.tech[i];
  }

  return "\n  <div class=\"card\">\n      <div class=\"card-body\">\n          <h4 class=\"card-title title-style\">".concat(job.title, "</h4>\n          <p class=\"firmName\"><b> ").concat(jobDTO.firmName, "</b></p>\n          <i class='fas fa-map-marker-alt' style='color:#e65c00'></i> ").concat(jobDTO.location, " <br>\n          <p class='far fa-clock' style='color:#595959'> <b>").concat(date, "<b></p><br>\n          <p style='color:#404040'>").concat(t, " &nbsp <span style=\"background-color:#e65c00; color:white;\">").concat(job.seniority, "</span></p>\n          <img src=\"http://localhost:9000/").concat(jobDTO.firmImage, "\" class=\"firmImage\"/>\n          <button class=\"gray-button\" value=\"").concat(job._id, "\">View more</button>\n      </div>\n  </div>\n\n  ");
};

exports.jobsTemplate = jobsTemplate;

var jobTemplate = function jobTemplate(jobDTO) {
  var job = jobDTO.job;
  var date = new Date(job.createdAt).toDateString();
  var requirements = job.requirements.split(".");
  var requirementsTemplate = " ";

  var _iterator = _createForOfIteratorHelper(requirements),
      _step;
  ...
  return "\n  <div class=\"card\">\n      <div class=\"card-body\">\n          <h4 class=\"card-title title-style\">".concat(job.title, "</h4>\n          <p class=\"firmName\"><b> ").concat(jobDTO.firmName, "</b></p>\n          <i class='fas fa-map-marker-alt' style='color:#e65c00'></i> ").concat(jobDTO.location, " <br>\n          <p class='far fa-clock' style='color:#595959'> <b>").concat(date, "<b></p><br><br>\n          <p class=\"description\">").concat(job.description, "</p>\n          <p  class=\"details\">Job Description, Requirements: <br> <span >").concat(requirementsTemplate, "</span></p>\n          <p style='color:#404040'>").concat(techTemplate, " &nbsp <span style=\"background-color:#e65c00; color:white;\">").concat(job.seniority, "</span></p>\n          <img src=\"http://localhost:9000/").concat(jobDTO.firmImage, "\" class=\"firmImageJob\"/>\n      </div>\n  </div>\n\n  ");
};

exports.jobTemplate = jobTemplate;

var fieldOfWorkTemplate = function fieldOfWorkTemplate(fields) {
  var options = "";
  ...
  return "<select class=\"form-control\" id=\"select\"> ".concat(options, " </select>");
};

exports.fieldOfWorkTemplate = fieldOfWorkTemplate;
...
var JobSearch = /*#__PURE__*/function () {
  function JobSearch(searchFormSelector, resultsContainerSelector, grayButtonSelector, fieldsSelector, filterFormSelector, linkSlector) {
  ...
  _createClass(JobSearch, [{
    key: "configureFromListener",
    value: function configureFromListener() {
      var _this = this;
      ...
      this.searchForm.addEventListener("submit", function (event) {
        ...
        var location = _this.searchForm.querySelector("#location").value;

        var fieldOfWork = _this.searchForm.querySelector("#select").value;

        fetch("http://localhost:9000/getJobs/" + location + "/" + fieldOfWork).then(function (response) {
          return response.json();
        }).then(function (results) {
          localStorage.setItem("users", JSON.stringify(results));
          return results.map(function (job) {
            return (0, _templates.jobsTemplate)(job);
          }).join("");
        }).then(function (jobs) {
          _this.resultsContainer.innerHTML = jobs;
          _this.filterForm.innerHTML = (0, _templates.filtersTemplate)();
        }).catch(function (err) {
    ...
    key: "clickedListener",
    value: function clickedListener() {
      this.resultsContainer.addEventListener('click', function (event) {
        if (event.target.classList.contains('gray-button')) {
          var idJob = document.querySelector('.gray-button').value; // console.log(idJob)
          // const url = "http://localhost:9000/getJob/" + idJob
          // SendHttpRequest(url)

          fetch("http://localhost:9000/getJob/" + idJob).then(function (response) {
            return response.json();
          }).then(function (results) {
            return results.map(function (job) {
              return (0, _templates.jobTemplate)(job);
            }).join('');
          }).then(function (jobs) {
            return document.querySelector('.result-container').innerHTML = jobs;
          }).catch(function (err) {
            return console.log(err);
          });
        }
    ...
    key: "populateSelection",
    value: function populateSelection() {
      document.addEventListener("DOMContentLoaded", function () {
        fetch("http://localhost:9000/getFieldsOfWork").then(function (response) {
          return response.json();
        }).then(function (results) {
          return (0, _templates.fieldOfWorkTemplate)(results);
        }).then(function (fields) {
          return document.querySelector("#fields").innerHTML = fields;
        }).catch(function (err) {
          return console.log(err);
        });
      });
    ...
    value: function filterJobs() {
      ...
      this.filterForm.addEventListener("submit", function (event) {
        ...
        var t = filterJobs.map(function (job) {
          return (0, _templates.jobsTemplate)(job);
        }).join("");
        _this2.resultsContainer.innerHTML = t;
      });
    }
  }]);
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./templates":"src/templates.js"}],"src/app.js":[function(require,module,exports) {
"use strict";

var _JobSearch = require("./JobSearch");

var jobSearch = new _JobSearch.JobSearch('#search-form', '.result-container', '.gray-button', '#fields', '#filter-form');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45579" + '/');
